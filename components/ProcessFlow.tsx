...
export default function ProcessFlow() {
  return (
    <div className="max-w-[70rem] m-auto flex flex-col items-center px-8 py-5">
      ...
      {/*Collection  */}
<div
  className="flex flex-col mb-12 rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-slate-800/60 md:flex-row">
  {/* <img
  ...
  <div className="flex flex-col justify-start p-8">
    <h5
      className="mb-8 tracking-wide text-4xl font-medium text-neutral-800 dark:text-neutral-50">
      Collection
    </h5>
    <p className="mb-4 tracking-wide text-base text-neutral-600 dark:text-neutral-200">
    We have a reliable and efficient waste collection system in place that covers residential, commercial, and industrial areas.
          Our team utilizes designated containers and scheduled pick-ups to
          gather waste, ensuring a clean and clutter-free environment.
    </p>
...
<div
  ...
  <div className="flex flex-col justify-start p-8">
    ...
    <p className="mb-4 tracking-wide text-base text-neutral-600 dark:text-neutral-200">
    Once collected, the waste is carefully transported to
          our facility using specialized vehicles equipped to handle different
          waste types. We prioritize safe transportation practices to prevent
          any potential harm to the environment or public health.
    </p>
...
{/* Recovery */}
<div
  className="mb-12 flex flex-col rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-slate-800/60 md:flex-row">
  {/* <img
    className="h-96 w-full rounded-t-lg object-cover md:h-auto md:w-48 md:rounded-none md:rounded-l-lg"
    src="https://tecdn.b-cdn.net/wp-content/uploads/2020/06/vertical.jpg"
    alt="" /> */}
  <div className="flex flex-col justify-start p-8">
    ...
    <p className="mb-4 tracking-wide text-base text-neutral-600 dark:text-neutral-200">
    At our facility, we employ advanced technologies and sorting
          techniques to maximize resource recovery. Our trained personnel
          carefully sort and segregate different waste streams, such as
          recyclables, hazardous materials, and organic waste. This enables us
          to divert materials from landfills and redirect them to appropriate
...
<div
  ...
  <div className=" flex flex-col justify-start p-8">
    <h5
      className="tracking-wide mb-8 text-4xl font-medium text-neutral-800 dark:text-neutral-50">
      Processing
    </h5>
    <p className="mb-4 tracking-wide text-base text-neutral-600 dark:text-neutral-200">
    The sorted waste undergoes various processing methods
          based on its nature. Recyclable materials, such as paper, plastics,
          glass, and metals, are processed through cutting-edge recycling
          technologies to transform them into valuable resources. Organic waste
          may be composted to produce nutrient-rich soil amendments, while
...
<div
  ...
  <div className=" flex flex-col justify-start p-8">
    ...
    <p className="tracking-wide mb-4 text-base text-neutral-600 dark:text-neutral-200">
    As part of our waste management process, we prioritize
          responsible and compliant disposal of residual waste that cannot be
          recycled or recovered. We adhere to stringent regulations and
          environmental guidelines to ensure that waste is disposed of in
          designated landfills or treatment facilities designed to minimize
